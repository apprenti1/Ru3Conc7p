<div class="container h-100 bg-transparent text-center d-flex flex-column justify-content-center align-items-center">
    <a href="<?= $baseurl ?>admin/produits/new">new</a>
    <table class="col-10">
        <thead>
        ...
        <tr class="border-bottom border-black">
            ...
            <td class="text-primary"><?= $value->getMaindoeuvre() ?> %</td>
            <td class="text-primary">
                <form action="<?= $baseurl ?>admin/produits/edit" method="post">
                    <input type="hidden" name="edit" value="<?= $value->getId() ?>">
                    <input type="submit" value="edit">
                </form>
                <form action="<?= $baseurl ?>admin/produits/del" method="post">
